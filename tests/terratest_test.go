...
func TestFull(t *testing.T) {
	...
	instanceName := fmt.Sprintf("test-policies-vmedia-%s", uniqueId)
...
{
	"Name":        "{{ .name }}",
	"Description": "{{ .name }} Virtual Media Policy.",
	...
	"Mappings": [
	  {
		...
		"DeviceType": "cdd",
		"FileLocation": "http://198.18.0.80/mount.iso",
		"HostName": "",
		"IsPasswordSet": false,
		"MountOptions": "noauto",
		"MountProtocol": "http",
		...
		"RemoteFile": "",
		"RemotePath": "",
		"SanitizedFileLocation": "198.18.0.80/mount.iso",
		"Username": "",
		"VolumeName": "http_server"
	  }
	]
}
`
